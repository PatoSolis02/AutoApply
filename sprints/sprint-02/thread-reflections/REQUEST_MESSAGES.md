# Sprint 02 Reflection Request Messages

Use these prompts verbatim in each thread.

## Generic Message (Any Sprint 02 Thread)
...
- Call out contract/runtime drift notes and remaining risks.
...
- tests/build output
- API contract conformance notes
- known endpoint/runtime risks
- end with STATUS: DONE or STATUS: BLOCKED
```
...
- compliance/runtime wiring observations
- policy enforcement risks and production caveats
- end with STATUS: DONE or STATUS: BLOCKED
```
...
- files changed summary
- tests run and outcomes
- package/import/runtime tradeoffs
- remaining migration cleanup items
- end with STATUS: DONE or STATUS: BLOCKED
```
...
- repo hygiene/tooling baseline decisions and tradeoffs
- any follow-up cleanup required
- end with STATUS: DONE or STATUS: BLOCKED
```
