...
function extractJobDetails() {
  ...
  const descriptionNode = document.querySelector("#job-details") || document.querySelector(".jobs-description-content__text");
...
chrome.runtime.onMessage.addListener((message, _sender, sendResponse) => {
  ...
  if (!valid) {
    sendResponse({ ok: false, error: "Could not extract all required fields from this page." });
    return;
  }
